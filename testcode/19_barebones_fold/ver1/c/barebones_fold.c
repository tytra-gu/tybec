...
int main(void) {
  ...
  //vout = (data_t *)malloc(sizeof(data_t)*SIZE); //redundant
...
void post ( FILE *fp
	...
	//fprintf(fp, "-------------------------------------------------------------------------------------------------------------------------------------------\n");
	fprintf(fp, "		   i,	   vin0(i),	   vin1(i),		  vconn_A_to_B(i),	 vconn_B_to_C(i),	vconn_C_to_D(i),	sout	   \n");
	//fprintf(fp, "-------------------------------------------------------------------------------------------------------------------------------------------\n");
	for (int i=0;i<SIZE;i++){ 
...
#endif	  
				 , i,  vin0[i],	 vin1[i], vconn_A_to_B[i],	vconn_B_to_C[i],   vconn_C_to_D[i],	 sout);
