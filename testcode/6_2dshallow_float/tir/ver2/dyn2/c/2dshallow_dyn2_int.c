...
// ======================================================================
  ...
  //for integer unit testing
   ...
   host_t dt      = (host_t) 3;
   host_t g       = (host_t) 10;  
   host_t eps     = (host_t) (FXS* 0.05); //unused
   ...
   host_t eps_g   = (host_t) (FXS* 0.05); //unused
...
// oclh_log_results
//------------------------------------------
void log_results ( host_t* etan_g
){
  printf("Logging data\n");
  FILE * feta_g;
  FILE * fp_verify;
  ...
  for (int i = 0; i < ROWS; ++i) {
    for (int j = 0; j < COLS; ++j) {
      fprintf(feta_g  ,"%d,  ", *(etan_g   + i*COLS + j));
    }//j
    fprintf(feta_g  ,"\n");
  }//i
