...
assign ivalid_todut = ((lincount<=`SIZE-`TY_GVECT) && (wi_count == 0)) ? ivalid_todut_r & iready_fromdut
                                                                      : 0;
...
// -----------------------------------------------------------------------------
initial  begin
  $fdisplay(fverify, ":: Time stamp = Thu Dec 19 17:56:07 2019 ::\n\n");
