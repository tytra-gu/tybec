...
// ----------------------------------------------------------------------------------
   ...
   // Get Accelerator compute device
    ...
    for (uint i = 0; i < how_many_words_to_compare; i=i+vect) {
      ...
      if (
        ...
        printf("ERROR,i=%d:: xn(e,a)=(%f,%d); un(e,a)=(%f,%d); vn(e,a)=(%f,%d); yn(e,a)=(%f,%f); \n"
          , i+w
  ...
  printf("Final value of counters at %d is cycles = %d, ivalids = %d, ovalids = %d\n", DATA_SIZE
          , h_axi00_ptr0_output[(DATA_SIZE-1)*4 + 0]
          , h_axi00_ptr0_output[(DATA_SIZE-1)*4 + 1]
          , h_axi00_ptr0_output[(DATA_SIZE-1)*4 + 2]
          );
