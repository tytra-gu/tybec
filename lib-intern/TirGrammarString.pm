...
# See for details: https://metacpan.org/pod/Parse::RecDescent
...
PNDMAP : "[" "pndmap" INTEGER "]" 
  {$return = $item{INTEGER};}

FUNC_CALL_INSTR : "call" PNDMAP(?) "@" CALLEE_FUNC_NAME "("  CALLED_FUNCT_ARGS[$arg[0], $item{CALLEE_FUNC_NAME} ] ")" 
...
MD_FI: "!" "fi" /,?/ "!" EXPRESSION #/ 
  {TirGrammarMod::actMD_FI(\@item, \%item, \@arg);}

COMPUTE_INSTR :  DEST_TYPE OPER_DEST  "=" OP OP_TYPE OPER1 "," OPER2 /,?/ MD_REDUCTION_SIZE[$item{OPER_DEST}, $item{OPER1}, $item{OPER2}, $arg[0]](s?) MD_FI[$item{OPER_DEST},$arg[0]](?) #?
...
MD_FUNC_RESOURCES: "!" "resources" /,?/ "!" "(" INTEGER1 "," INTEGER2 "," INTEGER3 "," INTEGER4 ")" #/
  #{print ">>>>>>>>>>>>>> Found MD_FUNC_RESOURCES\n";}
  {TirGrammarMod::MD_FUNC_RESOURCES(\@item, \%item, \@arg);}

FUNCT_DECLR : "define" "void" "@" FUNC_NAME "(" FUNCT_ARGS[$item{FUNC_NAME}] ")" FUNC_TYPE /,?/ MD_FUNC_RESOURCES[$item{FUNC_NAME},$arg[0]](?)
